...
void BMM150::read_mag_data() {
    ...
    i2c_read(BMM150_DATA_X_LSB, (uint8_t *)reg_data, BMM150_XYZR_DATA_LEN);
...
{
  I2C_StatusTypeDef res;
  res=I2C_WriteRegister( &hi2c1, BMM150_I2C_Address, address, 1, (uint8_t *)&data, 1);
#if 0
...
{
  volatile I2C_StatusTypeDef res;
  res=I2C_ReadRegister( &hi2c1, BMM150_I2C_Address, address, 1, buffer, length);
#if 0
  Wire.beginTransmission(BMM150_I2C_Address);
    Wire.write(address);
    Wire.endTransmission();
